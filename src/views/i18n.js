...
const i18n = {
  en: {
    ...
    roulette: "Roulette",
    rouletteRandom: "Giving you a random blob from your database.",
    rouletteNotImage: "If you can't see anything, you probably didn't get an image blob. You can always ",
    rouletteSpinAgain: "give it another spin!",
    profile: "Profile",
